...
const TABS: {
...
}[] = [
  {
    ...
    placeholder: "memory.placeholder.summary",
  },
  {
    key: "profile",
    ...
    placeholder: "memory.placeholder.profile",
  },
];
  ...
  return (
    <div className="space-y-6">
      <SpaceSectionHeader
        ...
        title={t("Memory")}
        description={t(
          "Memory keeps your learning summary and learner profile across sessions.",
        )}
        meta={
          toast ? (
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-[12px] text-[var(--muted-foreground)]">
            {t("Updated")}: {formatUpdatedAt(updatedAt, t, language)}
          </span>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div>
          ...
          <p className="mt-2 text-[11px] text-[var(--muted-foreground)]/40">
            {t("Ctrl/Cmd+S to save - Markdown supported")}
          </p>
        </div>
      ) : editorValue.trim() ? (
